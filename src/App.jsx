                  ...
                  <table style={{width:"100%",borderCollapse:"collapse",fontSize:13}}>
                    <thead style={{position:"sticky",top:0,zIndex:5,background:"#fafaf8"}}>
                      <tr>
                        ...
                        <th style={{...S.th,background:"#f0f0ec",color:"#333",position:"sticky",left:90,zIndex:3,boxShadow:"2px 0 4px rgba(0,0,0,.04)",minWidth:80}}>合計</th>
                        {usedCats.map(c=>(
                          <th key={c} style={S.th}>
                      ...
                      <tr style={{background:"#f5f5f0",borderTop:"2px solid #e0e0da"}}>
                        ...
                        <td style={{...S.td,fontWeight:700,background:"#f0f0ec",position:"sticky",left:90,zIndex:3,boxShadow:"2px 0 4px rgba(0,0,0,.04)"}}>{fmtYen(mTotal)}</td>
                        ...
                        return (
                          <Fragment key={date}>
                            <tr style={{...(di%2===0?{background:"#fff"}:{background:"#fdfdfb"}),...(isToday?{background:"#eef4fb"}:{})}}>
                              ...
                              <td style={{...S.td,fontWeight:600,background:"#fafaf8",position:"sticky",left:90,zIndex:1,boxShadow:"2px 0 4px rgba(0,0,0,.04)"}}>{fmtYen(dayTotal)}</td>
                              {usedCats.map(c=>{
...
const S = {
  ...
  thFix:     { textAlign:"left", position:"sticky", left:0, zIndex:4, background:"#fafaf8", minWidth:90, width:90, boxShadow:"2px 0 4px rgba(0,0,0,.04)" },
